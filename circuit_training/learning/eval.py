...
flags.DEFINE_string("init_placement", "", "File path to the init placement file.")
...
def main(_):
    gin.parse_config_files_and_bindings(
        ...
        [*_GIN_BINDINGS.value, "circuittraining.models.GrlModel.policy_noise_weight=0"],
        skip_unknown=True,
    )
...
if __name__ == "__main__":
    flags.mark_flags_as_required(["root_dir", "variable_container_server_address"])
