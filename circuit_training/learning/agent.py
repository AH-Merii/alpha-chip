...
from tf_agents.utils import common, eager_utils, nest_utils, object_identity, value_ops
...
class CircuitPPOAgent(ppo_agent.PPOAgent):
    ...
    def get_loss(
        ...
        old_value_predictions: types.Tensor | None = None,
    ...
    def _train(self, experience, weights):
        ...
        normalized_advantages = _normalize_advantages(advantages, variance_epsilon=1e-8)
        ...
        with tf.name_scope("Losses/"):
            ...
            tf.compat.v2.summary.scalar(
                ...
                data=loss_info.extra.kl_penalty_loss * self._report_loss_scaling_factor,
                step=self.train_step_counter,
            )
            tf.compat.v2.summary.scalar(
                name="clip_fraction",
