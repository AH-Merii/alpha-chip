...
from tf_agents.train import interval_trigger, learner
...
class CircuittrainingPPOLearner:
    ...
    def _create_datasets(self):
        ...
        def _filter_invalid_episodes(sample):
            ...
            data_model_id = tf.cast(tf.reduce_min(sample_info.priority), dtype=tf.int64)
