...
from circuit_training.dreamplace import dreamplace_util, placedb_plc
...
def optimize_using_dreamplace(plc, params, output_dir=None, hard_macro_movable=False):
    ...
    if hard_macro_movable:
        placer.placedb_plc.update_num_non_movable_macros(plc, num_non_movable_macros=0)
    logging.info(
