...
def print_and_save_result(plc, duration, method_name, filename_prefix, output_dir):
...
def get_dreamplace_params(
    ...
    if num_bins_x and num_bins_y:
        ...
        params.num_bins_x, params.num_bins_y = get_bin_size(canvas_width, canvas_height)
        logging.info(
