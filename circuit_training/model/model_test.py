...
flags.DEFINE_integer("dataset_repeat", 16, "Defines the number of dataset repeat.")
...
class ActorModelTest(test_utils.TestCase, parameterized.TestCase):
    ...
    def test_backwards_pass(self):
        ...
        time_step = tensor_spec.sample_spec_nest(time_step_spec, outer_dims=outer_dims)
